...
_VERSION_URL = f"https://raw.githubusercontent.com/{REPO}/{BRANCH}/src/dbox/__init__.py"
_CACHE = Path.home() / ".dbox" / "update-check.json"
...
def fetch_latest_version(timeout: float = 4.0) -> str | None:
    ...
    try:
        req = urllib.request.Request(_VERSION_URL, headers={"User-Agent": "dbox"})
