...
extensions, and recommended services. Powers both ``dbox init`` (which writes
a config) and ``dbox detect`` (which just reports).
"""
...
from dbox import plugins
from dbox.config import SUPPORTED_PHP
